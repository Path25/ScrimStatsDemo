...
Customer-facing claims are allowed only when their evidence and release boundary are recorded here. Drafts are not approval to send or publish.

## New-workspace activation follow-up

| Claim | Evidence | Allowed use | Prohibited interpretation |
|---|---|---|---|
