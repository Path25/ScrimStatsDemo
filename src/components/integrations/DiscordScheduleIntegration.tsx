        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className={`ss-mono border px-2 py-1 text-[11px] uppercase tracking-[0.16em] ${deliveryConfigured ? "border-[var(--workspace-success)]/35 bg-[var(--workspace-success)]/10 text-[var(--workspace-success)]" : "border-[#8994ff]/35 bg-[#8994ff]/10 text-[#aeb5ff]"}`}>{deliveryConfigured ? "Delivery active" : installation ? "Server connected — delivery not configured" : "Setup required"}</span>
            </div>
