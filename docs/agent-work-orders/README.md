...
Use filenames in the form `WO-YYYY-NNN-short-slug.md`. Do not move a work order to `done/` because code exists or local tests pass alone. Keep production, billing, entitlement, security, customer-communication, and deployment approval requirements explicit.
