...
|---|---|---|---|
| [WO-2026-040](proposed/WO-2026-040-discord-production-readiness-controlled-release.md) | QA and Release Auditor | Cleanup commits `53bf4fe` and `c861d8b` are deployed as active `discord-interactions` v11 with clean SHA `0181e9d3...864e6`; Theo confirmed removal of the temporary replay secret. Hosted source has no replay path, counts remain 6 scrims / 3 receipts / 8 Discord events / 2 pending / 6 attempts, and both workers remain inactive. | Independently confirm the secret name is absent, reconcile v11/source/count evidence, and route the remaining denial, retry/recovery, smoke, pilot, and release matrix. Exact replay remains unverified; do not retry or activate workers. Release remains HOLD. |
...
| [WO-2026-036](proposed/WO-2026-036-elite-opponent-preparation-playbooks.md) | QA and Release Auditor | Exact candidate `52f9d62` is deployed as Vercel `dpl_2NMVKZBTD1t6PQRWTvU4Zi6WqCcf`; only `WO-024 QA Tenant A` is live/enabled. Direct hosted checks pass Elite Owner/Admin allowance and Member/Viewer, unrelated-user, Free, and Pro denial; authenticated Owner empty state is visible and all workflow tables remain empty. | Execute create/link/approve/revise/archive/review lifecycle, provenance and missing/unavailable evidence states, Draft/Action/Scrim breadcrumbs, Member/Viewer browser denial, tenant-B/direct mutation/stale-version/invalid-source checks, and real 390px desktop/mobile presentation. This is fixture-only, not customer or release approval. |
