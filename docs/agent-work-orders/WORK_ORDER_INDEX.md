...
This is the authoritative ID registry for ScrimStats work orders. IDs are never reused, including cancelled, superseded, or completed work. The current reservation is `WO-2026-021`; the next available 2026 ID is `WO-2026-022`.
...
| WO-2026-009 | Enforce Collector entitlement below the browser | In Progress | Core Features Developer | [WO-2026-009](in-progress/WO-2026-009-collector-server-entitlement-enforcement.md) |
| WO-2026-010 | Enforce append-only service-role access for funnel events | Ready for QA | QA | [WO-2026-010](review/WO-2026-010-funnel-service-role-append-only-grants.md) |
...
| WO-2026-015 | Make Pro analytics legible and outcome-led | Ready for Development | Core Features Developer | [WO-2026-015](proposed/WO-2026-015-pro-analytics-legibility-and-value.md) |
...
| WO-2026-017 | Add tenant-safe workspace identity customization | Ready for Development | Core Features Developer | [WO-2026-017](proposed/WO-2026-017-workspace-identity-customization.md) |
...
| WO-2026-021 | Restore existing-account workspace creation and confirmation recovery | Ready for QA | QA | [WO-2026-021](proposed/WO-2026-021-existing-account-workspace-recovery.md) |
