...
const notificationSurfaceStyle = {
  "--workspace-surface": "#0d141b",
  "--workspace-muted": "#aebac2",
  "--workspace-subtle": "#84939e",
  "--workspace-rule": "rgba(226, 236, 232, 0.1)",
  "--workspace-rule-strong": "rgba(226, 236, 232, 0.18)",
  "--workspace-accent": "#11e2d0",
} as CSSProperties;
...
export function NotificationInbox() {
  ...
  return <DropdownMenu>
    ...
    <DropdownMenuContent align="end" style={notificationSurfaceStyle} className="z-[60] w-[min(24rem,calc(100vw-2rem))] border-[rgba(226,236,232,0.22)] bg-[#111a23] p-0 shadow-xl">
